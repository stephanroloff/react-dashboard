...
import { signInWithPassword } from "@/supabase/signInWithPassword";
    ...
    >
      <FieldGroup>
        ...
        <Controller
          ...
          render={({ field }) => (
            <Field>
              <FieldLabel htmlFor="email">{t("loginForm.email")}</FieldLabel>
              <Input
                {...field}
                id="email"
                type="email"
              ...
              />
              <FieldError>
                {errors.email?.message ? t("loginForm.emailError") : ""}
              </FieldError>
            </Field>
          )}
        />
        <Controller
          ...
          render={({ field }) => (
            <Field>
              ...
              />
              <FieldError>
                {errors.password?.message ? t("loginForm.passwordError") : ""}
              </FieldError>
            </Field>
          )}
        />
        ...
        <FieldError>
          {errors.root?.message ? t("loginForm.rootError") : ""}
        </FieldError>
